      ...
      <main className="pt-20">
        ...
        <section className="flex flex-col gap-20 justify-center pb-10 items-center">
          ...
          <p className="text-base md:text-lg lg:text-xl text-center lg:text-justify text-[#C2ECFF] font-figtree px-4 md:px-0">
            ...
            Espino, explorando sus metáforas y{" "}
            <br className="hidden lg:inline" /> simbolismos para conectar sus
            emociones con elementos visuales. Las ilustraciones, realizadas con
            un estilo <br className="hidden lg:inline" /> libre y expresivo,
            para capturar texturas orgánicas y transmitir la calidez de los
            paisajes cuzcatlecos.
          </p>
        </section>
