...
export default function FufurufaProject({
  project,
  slug,
}: FufurufaProjectProps) {
  ...
  return (
    <div className="min-h-screen bg-[#022733]">
      ...
      <main className="pt-20">
        ...
        {/* Imagen principal */}
        <section className="w-full h-[80vh] relative bg-[#022733]">
          <Image
            src={project.image}
            alt={project.title}
        ...
        <section className="container mx-auto px-6 py-10 md:py-20">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-4xl lg:text-5xl text-[#C2ECFF] font-big-shoulders mb-8">
              BOLSO FUFURUFAS - VAIZA EL SALVADOR
            </h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-[#C2ECFF] text-start font-figtree text-base md:text-lg lg:text-xl leading-relaxed mb-6">
                Esta bolsa gráfica creada para la marca VAIZA se inspira en Las
                Fufurufas, una palabra del lenguaje popular salvadoreño asociada
                a la convivencia, la charla, la picardía y los encuentros
                cotidianos. El diseño adopta la estética de estampilla, evocando
                lo simbólico y la idea de memoria cultural impresa.
              </p>
            </div>
          </div>
        </section>
