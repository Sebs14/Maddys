      ...
      <main className="pt-20">
        ...
        <section className="flex flex-col gap-20 justify-center pb-10 items-center">
          ...
          <p className="text-base md:text-lg lg:text-xl text-center text-[#C2ECFF] font-figtree px-4 md:px-0">
            ...
            diversas y pensadas para las personas.{" "}
            <br className="hidden lg:inline" /> Esa esencia la quise reflejar en
            las ilustraciones, dando vida a su espíritu en cada elemento.
          </p>
        </section>
